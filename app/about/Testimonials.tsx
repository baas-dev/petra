  ...
  return (
    <>
      <div className="bg-secondary">
        <div className="mb-8 w-full pt-24 text-center">
          <span className="mb-2 text-xs font-bold uppercase tracking-widest text-primary">
            Team Merits
          </span>
          <h1 className="mb-4 text-4xl font-bold leading-none tracking-tighter text-neutral-600">
            Our Achievements
          </h1>
        </div>
        ...
        <section className="h-full">
          ...
          <div className="container ">
            <IMG
              ...
              width={800}
              alt=""
              className="mx-auto w-3/4  rounded-xl pt-16"
            />
          </div>
        </section>
      </div>
...
export function TestimonialSwiper(props: { data }) {
  ...
  return props.data && props.data.length > 0 ? (
    <div className="p-8 text-center">
      <span className="mb-2 text-xs font-bold uppercase tracking-widest text-primary"></span>
      <h1 className="mb-4 text-4xl font-bold leading-none tracking-tighter text-neutral-600">
...
export const SingleTestimonial = ({ Label, Name, QuoteText, Image }) => {
  ...
  return (
    <div className="min-h-64 relative flex justify-center rounded-xl border-2 border-gray-100 bg-gray-300 shadow-md">
      <div className="relative w-full rounded-xl p-4 ">
        <div className="w-full">
          <div>
            ...
            <blockquote className="rounded-md border-l-8  !border-blue-300 bg-blue-100 p-8">
              <p className=" font-light italic text-gray-900 md:text-4xl ">
                {QuoteText}
              </p>
            </blockquote>
          </div>
          <div className="mx-auto mt-8 flex items-center justify-center gap-2 text-center">
            ...
            />
            <div className="">
              <h4 className="text-dark text-2xl font-semibold ">{Name}</h4>
              <p className="text-body-color text-xl font-light">{Label}</p>
            </div>
          </div>
        </div>
      </div>
